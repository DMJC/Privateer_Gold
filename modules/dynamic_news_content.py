...
,"confed" :     {"full" : ["Terran Confederation of Planets"]
                ,"nicks" : ["Confed"]
                ,"nickp" : ["Confeds"]
                ,"dnicks" : ["Origami"]
                ,"dnickp" : ["Origamis"]
...
,"AWACS" : {"full" : ["Armed Workers Against Corporate Slavery"]
                ...
                ,"dnicks": ["Pinko"]
                ,"dnickp": ["Pinkos"]
                ,"government" : ["local Soviet"]
                ,"possessive" : ["AWACS"]
                ,"homeworld" : ["Auriga"]
                ,"mstandname" : ["Marcus Dibnaevski"]
                ,"fstandname" : ["Kaye Borri"]
                }
...
,"kilrathi" :       {"full" : ["Kilrathi Empire"]
                ,"nicks" : ["Kilrathi"]
                ,"nickp" : ["Kilrathis"]
                ,"dnicks" :["Cat"]
                ,"dnickp" : ["Cats"]
                ,"government" : ["Kilrathi Nobility"]
                ,"possessive" : ["Kilrathi's"]
                ,"homeworld" : ["Kilrah"]
                }
,"retro":    {"full" : ["Interstellar Church of True Form's Return"]
                ,"nicks": ["True-Former"]
                ,"nickp": ["True-Formers"]
                ,"dnicks": ["Retro"]
                ,"dnickp": ["Retros"]
...
{"siege" :      {"start"        :{"success":    {"good"         : [(0.8,"all","BLOCKADE in VAR_system_system!\\The VAR_aggressor_government has openly reported to VAR_defender_full their intent to invade the VAR_system_system system today. The VAR_aggressor_possessive forces have strategically blocked all entrance and exit from VAR_system_system and continue a valiant assault upon the planet.")
                                                ...
                                                ,"bad"          : [(0.3,"all","VAR_aggressor_nickp Invasion Plans in VAR_system_system?\\It is a grave day in VAR_system_system today, as hordes of VAR_aggressor_full starships have senselessly commenced their bombardment of a VAR_defender_possessive planet in VAR_system_sector Sector. The inhabitants were doing nothing that would legally provoke hostile actions, yet VAR_aggressor_possessive troops have already begun their invasion procedures. Can anyone stop these cruel, heartless VAR_aggressor_dnickp?")
...
,"battle" :     {"end" :        {"success" :    {"good" : [(0.1,"all","VAR_defender_dnickp Vaporized in VAR_system_system!\\In the outer regions of the VAR_system_system system today, the VAR_aggressor_FG squadron of VAR_aggressor_nicks VAR_aggressor_FGtype ships in transit came across a group of VAR_defender_possessive VAR_defender_FGtype fighters on an intercept course with a VAR_aggressor_possessive passenger liner.  The hostiles were engaged and swiftly destroyed by the VAR_aggressor_FGtype squadron -- no energy sources remained active.\\\\\\GNN -- \"We\'re with it when it breaks!\"")
                                ...
                                ,"draw" :       {"bad"          : [(0.8,"all","Fight to the Draw in VAR_system_system\\The skirmish between the VAR_aggressor_possessive VAR_aggressor_FG and the notorious VAR_defender_nicks VAR_defender_FG squadron of VAR_defender_FGtype starships has ended with no decicive victor. Both sides took some blows, and the  VAR_aggressor_FG lost a VAR_aggressor_FGtype before the forces disengaged.\\\\\\GNN -- \"Our Snooze Is Your News\"")
                                                                          ,(1.0,"all","Privateers Expected to Loot the Dead!\\With the inconclusive result of a battle between VAR_aggressor_FGtype and VAR_defender_FGtype Class vessels, it is unfortunate that neither side were able to hold the battle site. As such, privateers and pirates are expected to loot the remaining hulls and frozen bodies of both forces, with the intention to sell all found on the open markets! GNN  -- We Support Free Enterprise!")
                                                                          ]
                                                ,"good"         : [(0.8,"all","VAR_aggressor_nicks Repulsed from VAR_system_system but not defeated\\A Battle erupted between the VAR_aggressor_possessive VAR_aggressor_FG squad and the VAR_defender_nicks forces. VAR_defender_mstandname, wing leader of the VAR_defender_nicks squadron, the VAR_defender_FG, said, \"We definitely did not fire the first shot. We were pursued and attacked-- so we defended ourselves and pulverized one of their VAR_aggressor_FGtype craft. We were neither outmanned nor outgunned, we just repulsed the enemy, that's all.\" Sources indicate that while both attacker and defender sustained damage, no clear winner emerged from the skirmish, and casualites on both sides were limited.\\\\\\GNN -- \"Interviews while you cruise\"")
                                                                          ,(1.0,"all","WEALTH FOR THE TAKING!\\Head to VAR_system_system System in VAR_system_sector. VAR_aggressor_FGtype and VAR_defender_FGtype Class hulls are ripe for looting after a battle there today! With an inconclusive result to the battle, neither side was able to hold the location, so ships of both forces are available for the taking! GNN  -- You Pay for Our Advertising!")
                                                                          ]
...
,"fleetbattle":
                {"start" :      {"success" :    {"good" :               [(0.3,"all","Strike Fleet Engages in Retaliatory Attacks!\\Reports have filtered in of a retaliatory attack on a VAR_defender_possessive VAR_defender_FGtype raiding party. While all reports state that the raiding party has been decimated, VAR_defender_possessive reinforcements are rushing to the fray.\\The Commander of the Strike Fleet was quoted as saying \"They strike at our homes, our convoys and our people. It won\'t matter where they run, we will follow  -- and they will end defeated! Should we discover that this raiding party had official sanction, then VAR_defender_possessive forces beware, you shall suffer the same fate.\"\\\\More updates to follow.")
                                                        ...
                                                        ,"bad" :                [(0.3,"all","VAR_defender_possessive VAR_defender_FGtype Defence Force Fired Upon!\\ VAR_aggressor_FGtype's fired upon VAR_defender_FGtype class vessels in an unprovoked attack only hours ago! Casualties are currently unknown, but VAR_defender_possessive reinforcements are being rushed to the battle site even now.\\The commander of VAR_defender_FG Defense Forces has stated in a press release \"They started this, but we'll finish it! It may be that diplomatic negotiations will require the retreat of all forces from the battlezone  -- but we won\'t go until the VAR_aggressor_dnickp do!\\\\Stay online for further updates.")]
                ...
                ,"end" :        {"success" :    {"good" :               [(0.3,"all","Strike Fleet Goes Above & Beyond the Call of Duty!\\Following on from previous reports, we can now announce that the VAR_aggressor_possessive Strike Fleet VAR_aggressor_FG has exceeded all terms of its mission briefing. In a stunning display of deep space logistics and judicious use of brilliant battle tactics, the VAR_defender_possessive raiding party, condemned to destruction for atrocities committed in VAR_aggressor_full space, was vaporized as it neared sanctuary. To add insult to injury, this heroic fleet then totally destroyed all remaining defensive forces insystem, before jumping back to friendly space!\\What a success! What a truly outstanding feat of skill, daring and sheer luck! Several commendations, medals and awards are expected to be handed out in an awards ceremony to be held on the return of the fleet to drydock.\\But now we must consider, with VAR_system_system System now defenseless, whether to invade and annex that system, bringing to a halt all further raiding.\\\\GNN  -- bringing the celebration to you.")
                                                        ...
                                                        ,"bad" :                [(0.3,"all","Fears of System Loss!\\Both trade convoys and a large percentage of defense forces were lost today in VAR_system_system System, after an incursion consisting of VAR_aggressor_dnicks VAR_aggressor_FGtype Class vessels engaged in terrorist activities. The people of VAR_system_system System now fear that the bold and open nature of these actions indicates it is a prelude to an invasion by the VAR_aggressor_full.\\Government sources are now scrambling all available forces, apparently even removing ships of the line from other fleets, to bolster defenses in the system. Can these forces hold the system? Will those people remaining be able to escape? Will they be forced to endure the crushing rule of the VAR_aggressor_government? We do not know.\\\\GNN  -- when rumour-mongering is not enough.")
                                ...
                                ,"draw" :               {"good"         : [(0.8,"all","VAR_aggressor_dnickp staved off by the VAR_defender_nicks VAR_defender_FG in VAR_system_system\\After hours of pulverizing blows, the VAR_defender_nicks forces successfully fought off the VAR_aggressor_nickdp, although both the VAR_defender_FG and the VAR_aggressor_nicks VAR_aggressor_FG fleet were left in ruins.   Comprised of the VAR_aggressor_FGtype flagship and numerous other fighters, the VAR_aggressor_FG possessed formidable firepower.  The severe casualties sustained by both sides are deemed to be a result of inadequate point defense during the extended long range missile bombardment.  The few remaining fighters were incapacitated and left in space without resupply as the capital vessels including the VAR_defender_FGtype flagship were eradicated.  The VAR_defender_government issued a statement saying, \"Though damage to both sides was beyond severe, the VAR_defender_nicks forces did an admirable job staving off the attack, and the morale blow to the VAR_aggressor_dnickp will be brutal.\"\\\\\\GNN -- \"We mislead 'less you reread\"")
                                                        ...
                                                        ,"neutral"              : [(0.8,"all","VAR_aggressor_nicks VAR_aggressor_FG and VAR_aggressor_nicks VAR_aggressor_FG wipe each other out in VAR_system_system\\A nasty battle erupted into a fleet slaughter in the VAR_system_system as VAR_aggressor_nicks and VAR_defender_nicks ships died left and right.  No ship was left functional in the slaughter and many pilots are thought to be wasting away on a few hours of life support.  GNN reccommends humanitarian aid to the VAR_system_system.  This could be a battle that demoralizes both the VAR_aggressor_full and the VAR_defender_full. No concrete statement was issued by either government.\\\\\\GNN --\"Our flair is your care\"")
                                                                                ,(0.3,"all","VAR_defender_possessive Raiding Party Reaches Sanctuary; VAR_aggressor_possessive Strike Fleet Withdraws.\\News just received that the VAR_aggressor_possessive Strike Fleet has withdrawn from VAR_system_system space after learning that their prey, the VAR_defender_possessive raiding party, had safely reached port. With VAR_defender_nicks forces aligning against it, the strike force withdrew to friendlier space, there to await new orders and simultaneously denying VAR_defender_nicks forces a target.\\We now await the decision of the VAR_aggressor_government. Will they escalate this encounter with further forces? Will they withdraw completely from the engagement?\\GNN  -- we know, so you know.")]
                                                        }


                                ,"loss" :               {"good" :               [(0.3,"all","VAR_aggressor_full Strike Fleet Ceases to Exist!\\We cross to our roving reporter live.\\\'As you can see, there is celebration all over VAR_system_system today. Just a few hours ago the VAR_defender_possessive Defense Force confirmed the VAR_aggressor_possessive Strike Fleet was defeated by auxiliaries, in a battle near one of the jump points leading outsystem. The latest trade convoy, lead by the august ship VAR_defender_FG, also attained dock unscathed. Defense forces are now mopping any remaining resistance.\\Survivors (if any) will be held on charges of piracy and terrorism. Summary executions are to follow arraignment!\'\\It is also believed that the VAR_aggressor_possessive flagship, the VAR_aggressor_FG, was captured intact after having her engines crippled in a prior engagement with the trade convoy.")
...
,"destroyed":
                        {"end" :        {"success" :    {"good" : [(0.6,"all","VAR_system_system: VAR_defender_FG Debris!\\Debris believed to be from the VAR_defender_FGtype of the VAR_defender_possessive Squadron VAR_defender_FG has been found today in VAR_system_system.  This group is believed to be responsible for various attacks on VAR_dockedat_possessive installations in and around the area in the past few months, including an attack on Major General VAR_dockedat_mstandname's entorage.  These VAR_defender_dnickp will not be missed by anyone around here.\\\\\\GNN -- \"We report REAL news\"")
                                                ...
                                                ,"neutral"      : [(0.5,"all","VAR_defender_FG Destroyed in VAR_system_system:\\A squadron of mainly VAR_defender_FGtype ships was destroyed today in the VAR_system_system system.  More afraid of VAR_dockedat_possessive forces than we were of them, their destruction will not affect business in the area, let alone on VAR_dockedat_homeworld.")
                                                                  ...
                                                                  ,(0.9,"all","Ships Lost!\\News just received of a VAR_defender_nicks light patrol lost in VAR_system_system. It appears from the remains of the VAR_defender_FGtype craft that one escape pod had survived.\\It was found, too close to the system\'s sun to be retrieved. Rescue ships hove to, showing their respect for the disintegrating ejection pod.\\VAR_defender_government mourns the loss of this unknown pilot, and no doubt the information of what happened.\\GNN  -- We mourn for all who have lost their lives in battle.")
                                                                  ,(0.8,"all","Squad Leader Sacrificed.\\A VAR_defender_possessive squad leader was executed yesterday on a charge of dereliction of duty. In an apparently blatent disregard for orders, the squad leader ordered VAR_defender_FG into an encounter with vastly superior VAR_aggressor_nicks forces. The squad leader was the only survivor.\\After receiving news of the execution, the VAR_aggressor_government released flight data revealing that the squad leader was not derelict in performance of her duties, - ordering the flightgroup to flee and report the opposition presence - but should be hailed as a hero after a valiant rearguard action, downing several opposition fighters and sacrificing her ship.\\Such a stunning public relations coup can only serve to sting the VAR_defender_government, and we at GNN expect them to respond with military force  -- ships are already being moved into an invasion position.\\GNN  -- We know all about insulting.")
                                                                  ]
                                                }
                                }
                }
